...
func (fake *FakeGHRunner) IssueList(arg1 string, arg2 string) ([]vcs.Issue, error) {
...
func (fake *FakeGHRunner) IssueListCallCount() int {
	fake.issueListMutex.RLock()
	defer fake.issueListMutex.RUnlock()
	return len(fake.issueListArgsForCall)
}

func (fake *FakeGHRunner) IssueListCalls(stub func(string, string) ([]vcs.Issue, error)) {
	fake.issueListMutex.Lock()
	defer fake.issueListMutex.Unlock()
	fake.IssueListStub = stub
}

func (fake *FakeGHRunner) IssueListArgsForCall(i int) (string, string) {
	fake.issueListMutex.RLock()
	defer fake.issueListMutex.RUnlock()
...
func (fake *FakeGHRunner) IssueListReturns(result1 []vcs.Issue, result2 error) {
	fake.issueListMutex.Lock()
	defer fake.issueListMutex.Unlock()
...
func (fake *FakeGHRunner) IssueListReturnsOnCall(i int, result1 []vcs.Issue, result2 error) {
	fake.issueListMutex.Lock()
	defer fake.issueListMutex.Unlock()
	fake.IssueListStub = nil
